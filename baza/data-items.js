...
//
// stats двигают характеристики, а через них — пороги по 10 пунктов.
// atk и def прибавляются к броскам напрямую.
// ═══════════════════════════════════════════════════════════

    window.masterItemsDB = {
        rusty_sword: { name: "Ржавый Меч", type: "gear", slot: "mainhand", classes: ['warrior'], cost: 7, isLoot: true, icon: GITHUB_URL + "assets/gear/warrior/mainhand/rusty_sword.png", stats: {}, atk: 1, def: 0, desc: "+1 Шанс Атаки" },
        rusty_axe: { name: "Ржавый Топор", type: "gear", slot: "mainhand", classes: ['warrior'], cost: 7, isLoot: true, icon: GITHUB_URL + "assets/gear/warrior/mainhand/rusty_axe.png", stats: {}, atk: 1, def: 0, desc: "+1 Шанс Атаки" },
        rusty_double_hands_axe: { name: "Ржавый Двуручный Топор", type: "gear", slot: "mainhand", isTwoHanded: true, classes: ['warrior'], cost: 10, isLoot: true, icon: GITHUB_URL + "assets/gear/warrior/mainhand/rusty_double_hands_axe.png", stats: {str: 1}, atk: 1, def: 0, desc: "+1 Атака, +1 Сила (2-Руч)" },
        rusty_dagger: { name: "Ржавый Кинжал", type: "gear", slot: "mainhand", classes: ['archer','mage'], cost: 6, isLoot: true, icon: GITHUB_URL + "assets/gear/archer/mainhand/rusty_dagger.png", stats: {}, atk: 1, def: 0, desc: "+1 Шанс Атаки" },
        short_bow: { name: "Короткий Лук", type: "gear", slot: "mainhand", classes: ['archer'], cost: 12, isLoot: true, isTwoHanded: true, icon: GITHUB_URL + "assets/gear/archer/mainhand/short_bow.png", stats: {agi: 1}, atk: 1, def: 0, desc: "+1 Атака, +1 Ловк (2-Руч)" },
        stick_staff: { name: "Посох из Палки", type: "gear", slot: "mainhand", classes: ['mage','priest'], cost: 10, isLoot: true, isTwoHanded: true, icon: GITHUB_URL + "assets/gear/mage/mainhand/stick_staff.png", stats: {int: 1}, atk: 1, def: 0, desc: "+1 Атака, +1 Инт (2-Руч)" },
        ambrosia_wand: { name: "Палочка (Амброзия)", type: "gear", slot: "mainhand", classes: ['mage','priest'], cost: 6, isLoot: true, icon: GITHUB_URL + "assets/gear/mage/mainhand/ambrosia_wand.png", stats: {}, atk: 1, def: 0, desc: "+1 Шанс Атаки" },
        wooden_shield: { name: "Деревянный Щит", type: "gear", slot: "offhand", classes: ['warrior','priest'], cost: 5, isLoot: true, icon: GITHUB_URL + "assets/gear/offhand/wooden_shield.png", stats: {}, atk: 0, def: 1, desc: "+1 Шанс Защиты" },
        dried_frog: { name: "Сушеная Лягушка", type: "gear", slot: "offhand", classes: ['all'], cost: 5, isLoot: true, icon: GITHUB_URL + "assets/gear/offhand/dried_frog.png", stats: {int: 1}, atk: 0, def: 0, desc: "+1 Интеллект" },
        rusty_dagger_off: { name: "Кинжал (Левый)", type: "gear", slot: "offhand", classes: ['all'], cost: 6, isLoot: true, icon: GITHUB_URL + "assets/gear/archer/mainhand/rusty_dagger.png", stats: {}, atk: 1, def: 0, desc: "+1 Атаки (Dual)" },
        ...
        /* У КАЖДОГО ЗАКЛИНАНИЯ СВОЙ УРОН. Раньше поля не было вовсе, и движок
           считал ВСЕМ одинаково: 6 + интеллект. Огненный шар и ледяной шип
           били одинаково, хотя у шипа слабее удар и есть обморожение. */
        scroll_fire: { name: "Том: Огненный Шар", type: "gear", subtype: "attack", slot: "magic", classes: ['mage'], cost: 25, manaCost: 10, spellDamage: 6, icon: GITHUB_URL + "assets/gear/spells/fireball.png", stats: {}, atk: 0, def: 0, desc: "Урон 6+ИНТ (10 MP)" },
        ...
        old_plated_gloves: { name: "Старые Латные Перчатки", type: "gear", slot: "gloves", classes: ['warrior'], cost: 5, icon: GITHUB_URL + "assets/gear/warrior/gloves/old_plated_gloves.png", stats: {str: 1}, atk: 0, def: 0, desc: "+1 Атака" },
        ...
        book_heal: { name: "Прикосновение Лекаря", type: "gear", subtype: "heal", slot: "magic", classes: ['priest'], cost: 25, manaCost: 7, icon: GITHUB_URL + "assets/gear/spells/healing_hand.png", stats: {}, atk: 0, def: 0, desc: "Лечение 6+ИНТ (7 MP)" },
        scroll_icebolt: { name: "Том: Ледяной Шип", type: "gear", subtype: "attack", slot: "magic", classes: ['mage'], cost: 25, manaCost: 10, spellDamage: 4, freezeRounds: 1, freezes: true, icon: GITHUB_URL + "assets/gear/spells/icebolt.png", stats: {}, atk: 0, def: 0, desc: "Урон 4+ИНТ и обморожение: враг пропускает ход (10 MP)" },
        book_revive: { name: "Воскрешение", type: "gear", subtype: "revive", slot: "magic", classes: ['priest'], cost: 0, manaCost: 10, icon: GITHUB_URL + "assets/gear/spells/resurection.png", stats: {}, atk: 0, def: 0, desc: "Поднять павшего с 25% HP. Раз в день (10 MP)" },
        ...
        relic_spook: { name: "Мистер Спук", type: "gear", slot: "relic", classes: ['all'], cost: 0, cooldownDays: 7, icon: GITHUB_URL + "assets/gear/relic/relic_spook.png", stats: {}, atk: 0, def: 0, desc: "Зовёт Спука в бой. Перезарядка 7 дней" }
    };
