        ...
        'chapter1': {
            ...
            scenarios: [
                ...
                { id: 'sc_intro', name: "Интро", kind: 'story',
                  img: 'assets/chapters/chapter_1/intro.png',
                  stream_file: 'assets/chapters/chapter_1/intro.png',
                ...
                { id: 'sc_first_town', name: "1. Портовый город", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_1_first_town.png',
                  stream_file: 'assets/chapters/chapter_1/scene_1_first_town.png',
                ...
                { id: 'sc_robbery', name: "2. Ограбление", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_2_first_banditos.png',
                  stream_file: 'assets/chapters/chapter_1/scene_2_first_banditos.png',
                ...
                { id: 'sc_dragons_eggs', name: "3. Драконьи яйца", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_3_dragons_egs.png',
                  stream_file: 'assets/chapters/chapter_1/scene_3_dragons_egs.png',
                ...
                { id: 'sc_pirat_k', name: "4. Капитан Адрестанец", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_4_pirat_K.png',
                  stream_file: 'assets/chapters/chapter_1/scene_4_pirat_K.png',
                ...
                { id: 'sc_taverna', name: "5. Таверна снаружи", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_5_taverna.png',
                  stream_file: 'assets/chapters/chapter_1/scene_5_taverna.png',
                  next: [{ to: 'sc_bar', label: 'Заходим внутрь' }] },

                { id: 'sc_bar', name: "6. Знакомство в баре", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_6_bar.png',
                  stream_file: 'assets/chapters/chapter_1/scene_6_bar.png',
                ...
                { id: 'sc_friendship', name: "7. Начало дружбы", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_9_start_friendship.png',
                  stream_file: 'assets/chapters/chapter_1/scene_9_start_friendship.png',
                ...
                { id: 'sc_desk', name: "8. Доска объявлений ⭐РАЗВИЛКА", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_7_desk.png',
                  stream_file: 'assets/chapters/chapter_1/scene_7_desk.png',
                ...
                { id: 'sc_shaterochka', name: "9. ШатерОчка 🪙", kind: 'shop',
                  img: 'assets/chapters/chapter_1/scene_8_shaterochka.png',
                  stream_file: 'assets/chapters/chapter_1/scene_8_shaterochka.png',
                ...
                { id: 'sc_guards', name: "10. Стражники", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_10_guards.png',
                  stream_file: 'assets/chapters/chapter_1/scene_10_guards.png',
                ...
                { id: 'sc_tunnel', name: "11. Тоннель", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_11_tunel.png',
                  stream_file: 'assets/chapters/chapter_1/scene_11_tunel.png',
                  isDark: true,
                ...
                { id: 'sc1_rats', name: "12. Крысиный патруль", kind: 'battle',
                  img: 'assets/chapters/chapter_1/battle_sewerage_dh.png',
                  stream_file: 'assets/streamer/chapter_1/fights/rats_fight.mp4',
                  stream_still: 'assets/chapters/chapter_1/scene_12_battle_sewerage_16_9.png',
                  isDark: true,
                  gm_text: "Первый бой, лёгкий. Последний пацюк убегает — за ним слышно рычание.",
                  configs: {
                      easy: { xp: 30, enemies: ['fat_rat', 'fat_rat'] },
                      normal: { hpMult: 1.55, xp: 80, enemies: ['fat_rat', 'fat_rat', 'fat_rat', 'fat_rat', 'fat_rat'] },
                      hard: { hpMult: 1.5, xp: 125, enemies: ['fat_rat', 'fat_rat', 'fat_rat', 'fat_rat', 'fat_rat', 'fat_rat'] }
                  },
                  next: [
                ...
                { id: 'sc2_king', name: "13. Король Нечистот", kind: 'battle',
                  img: 'assets/chapters/chapter_1/battle_sewerage_boss_dh.png',
                  stream_file: 'assets/streamer/chapter_1/fights/King_rat.mp4',
                  stream_still: 'assets/chapters/chapter_1/scene_13_battle_sewerage_boss_16_9.png',
                  isDark: true,
                  ...
                  configs: {
                      ...
                      normal: { hpMult: 1.95, xp: 115, enemies: ['rat_king', 'fat_rat', 'fat_rat'] },
                      hard: { xp: 175, enemies: ['rat_king', 'fat_rat', 'fat_rat', 'fat_rat', 'fat_rat', 'fat_rat'] }
                  },
                  next: [{ to: 'sc_first_reward', label: 'Выходим наверх' }] },

                { id: 'sc_first_reward', name: "14. Первая награда", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_14_first_reward.png',
                  stream_file: 'assets/chapters/chapter_1/scene_14_first_reward.png',
                ...
                { id: 'sc_graf_rafael', name: "16. Граф Рафаэль", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_15_graf_rafael.png',
                  stream_file: 'assets/chapters/chapter_1/scene_15_graf_rafael.png',
                ...
                { id: 'sc_dark_wood', name: "17. Тёмный лес", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_16_dark_wood.png',
                  stream_file: 'assets/chapters/chapter_1/scene_16_dark_wood.png',
                  isDark: true,
                ...
                { id: 'sc3_wolves', name: "18. Павшие в лесу", kind: 'battle',
                  img: 'assets/chapters/chapter_1/battle_dark_forrest_dh.png',
                  stream_file: 'assets/streamer/chapter_1/fights/forest_fight.mp4',
                  stream_still: 'assets/chapters/chapter_1/scene_17_battle_dark_forrest_16_9.png',
                  isDark: true,
                  ...
                  configs: {
                      ...
                      normal: { hpMult: 1.8, xp: 115, enemies: ['wild_wolf', 'wild_wolf', 'wild_wolf', 'wild_wolf'] },
                      hard: { hpMult: 1.25, xp: 175, enemies: ['wild_wolf', 'wild_wolf', 'wild_wolf', 'wild_wolf', 'wild_wolf'] }
                  },
                ...
                { id: 'sc4_alpha', name: "19. Альфа-Хищник", kind: 'battle',
                  img: 'assets/chapters/chapter_1/battle_dark_forrest_dh.png',
                  stream_file: 'assets/streamer/chapter_1/fights/forest_fight.mp4',
                  stream_still: 'assets/chapters/chapter_1/scene_18_battle_dark_forrest_16_9.png',
                  isDark: true,
                  ...
                  configs: {
                      ...
                      normal: { xp: 145, enemies: ['direwolf', 'wild_wolf', 'wild_wolf', 'wild_wolf', 'wild_wolf'] },
                      hard: { hpMult: 1.15, xp: 225, enemies: ['direwolf', 'wild_wolf', 'wild_wolf', 'wild_wolf', 'wild_wolf'] }
                  },
                  next: [{ to: 'sc_second_reward', label: 'Осматриваем труп в красном' }] },

                { id: 'sc_second_reward', name: "20. Вторая награда", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_19_second_reward.png',
                  stream_file: 'assets/chapters/chapter_1/scene_19_second_reward.png',
                ...
                { id: 'sc_relic_ball', name: "21. Мячик 🎾", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_22_frist_relic.png',
                  stream_file: 'assets/chapters/chapter_1/scene_22_frist_relic.png',
                ...
                { id: 'sc_who_are_you', name: "22. Кто вы, мистер?", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_20_whoyou_are_mister_spook.png',
                  stream_file: 'assets/chapters/chapter_1/scene_20_whoyou_are_mister_spook.png',
                ...
                { id: 'sc_mister_spook', name: "23. Мистер Спук 🤝", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_21_mister_spook.png',
                  stream_file: 'assets/chapters/chapter_1/scene_21_mister_spook.png',
                ...
                { id: 'sc_back_to_graf', name: "24. Снова к Графу", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_23_back_to_graf.png',
                  stream_file: 'assets/chapters/chapter_1/scene_23_back_to_graf.png',
                ...
                { id: 'sc_backyard', name: "25. Двор ⭐РАЗВИЛКА", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_24_backyard.png',
                  stream_file: 'assets/chapters/chapter_1/scene_24_backyard.png',
                ...
                { id: 'sc_veranda', name: "26. Теплица", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_25_veranda.png',
                  stream_file: 'assets/chapters/chapter_1/scene_25_veranda.png',
                ...
                { id: 'sc_barn', name: "27. Амбар", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_26_barn.png',
                  stream_file: 'assets/chapters/chapter_1/scene_26_barn.png',
                  gm_text: "Полдня впустую: забрела старая собака и умерла. Вот и вся падаль.",
                  next: [{ to: 'sc_backyard', label: '↩ Обратно во двор' }] },

                { id: 'sc_well', name: "28. Колодец", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_27_well.png',
                  stream_file: 'assets/chapters/chapter_1/scene_27_well.png',
                ...
                { id: 'sc_surprise', name: "29. Сюрприз ⭐РАЗВИЛКА", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_28_surprise.png',
                  stream_file: 'assets/chapters/chapter_1/scene_28_surprise.png',
                ...
                { id: 'sc_bribe', name: "30. Взятка", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_33_bribe.png',
                  stream_file: 'assets/chapters/chapter_1/scene_33_bribe.png',
                ...
                { id: 'sc_threats', name: "31. Угрозы", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_29_threats.png',
                  stream_file: 'assets/chapters/chapter_1/scene_29_threats.png',
                ...
                { id: 'sc5_bandits', name: "32. Разборка у Графа", kind: 'battle',
                  img: 'assets/chapters/chapter_1/battle_graff_dh.png',
                  stream_file: 'assets/streamer/chapter_1/fights/Graf_fight.mp4',
                  stream_still: 'assets/chapters/chapter_1/scene_30_banditos_fight.png',
                  ...
                  configs: {
                      ...
                      normal: { hpMult: 1.15, xp: 195, enemies: ['bandit_leader', 'bandit', 'bandit_archer', 'bandit_archer', 'bandit_archer', 'bandit_archer'] },
                      hard: { hpMult: 1.2, xp: 300, enemies: ['bandit_leader', 'bandit', 'bandit', 'bandit_archer', 'bandit_archer', 'bandit'] }
                  },
                  next: [{ to: 'sc_mercy', label: 'Тащим Графа страже' }] },

                { id: 'sc_mercy', name: "33. Пощада", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_31_mercy.png',
                  stream_file: 'assets/chapters/chapter_1/scene_31_mercy.png',
                  next: [{ to: 'sc_arrest', label: 'Сдаём стражникам' }] },

                { id: 'sc_arrest', name: "34. Арест", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_32_arest.png',
                  stream_file: 'assets/chapters/chapter_1/scene_32_arest.png',
                ...
                { id: 'sc_pirat_final', name: "35. Капитан снова", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_34_pirat_K.png',
                  stream_file: 'assets/chapters/chapter_1/scene_34_pirat_K.png',
                ...
                { id: 'sc_all_aboard', name: "36. Все на борт", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_35_all_aboard_the_ship.png',
                  stream_file: 'assets/chapters/chapter_1/scene_35_all_aboard_the_ship.png',
                  next: [{ to: 'sc_sailing', label: 'Отплытие' }] },

                { id: 'sc_sailing', name: "37. Отплытие — КОНЕЦ ГЛАВЫ", kind: 'story',
                  img: 'assets/chapters/chapter_1/scene_36_sailing.png',
                  stream_file: 'assets/chapters/chapter_1/scene_36_sailing.png',
