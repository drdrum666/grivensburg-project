            ...
            scenarios: [
                ...
                { id: 'sc1_rats', name: "12. Крысиный патруль", kind: 'battle',
                  ...
                  configs: {
                      ...
                      normal: { xp: 80, enemies: ['fat_rat','fat_rat','fat_rat','fat_rat'] },
                      hard: { xp: 125, enemies: ['fat_rat','fat_rat','fat_rat','fat_rat','fat_rat'] }
                  },
                  next: [
                ...
                { id: 'sc2_king', name: "13. Король Нечистот", kind: 'battle',
                  ...
                  configs: {
                      ...
                      normal: { xp: 115, enemies: ['rat_king', 'fat_rat'] },
                      hard: { xp: 175, enemies: ['rat_king', 'fat_rat', 'fat_rat'] }
                  },
                ...
                { id: 'sc3_wolves', name: "18. Павшие в лесу", kind: 'battle',
                  ...
                  configs: {
                      ...
                      normal: { xp: 115, enemies: ['wild_wolf', 'wild_wolf', 'wild_wolf', 'wild_wolf'] },
                      hard: { xp: 175, enemies: ['wild_wolf', 'wild_wolf', 'wild_wolf', 'wild_wolf', 'wild_wolf'] }
                  },
                ...
                { id: 'sc4_alpha', name: "19. Альфа-Хищник", kind: 'battle',
                  ...
                  configs: {
                      ...
                      normal: { xp: 145, enemies: ['direwolf', 'wild_wolf', 'wild_wolf'] },
                      hard: { xp: 225, enemies: ['direwolf', 'wild_wolf', 'wild_wolf', 'wild_wolf'] }
                  },
                ...
                { id: 'sc5_bandits', name: "32. Разборка у Графа", kind: 'battle',
                  ...
                  configs: {
                      ...
                      normal: { xp: 195, enemies: ['bandit_leader', 'bandit', 'bandit_archer'] },
                      hard: { xp: 300, enemies: ['bandit_leader', 'bandit', 'bandit', 'bandit_archer'] }
                  },
